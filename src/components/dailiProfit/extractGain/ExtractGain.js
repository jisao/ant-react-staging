...
class checkPending extends React.Component {
    ...
    onTabChange = (key) => {
        ...
        switch (key) {
            ...
            case "待审核详情":
                this.state.url = "/withdraw/auditList";
                this.curCheckState = "withdraw-checkPending";
                break;
            case "出金审核详情":
                this.state.url = "/withdraw/cashList";
                this.curCheckState = "withdraw-outPending";
                break;
            case "审核未通过详情":
                this.state.url = "/withdraw/rejectList";
                this.curCheckState = "withdraw-unapprove";
                break;
            case "审核失败详情":
                this.state.url = "/withdraw/failList";
                this.curCheckState = "withdraw-checkFail";
                break;
            case "审核成功详情":
                this.state.url = "/withdraw/sucList";
                this.curCheckState = "withdraw-checkSuccess";
                break;
        }
        this.setState({
            url: this.state.url,
    ...
    linkDetails = (record) => {
        ...
        this.props.history.push("/main/extractGainDetails")
    }
