...
class checkPending extends React.Component {
    ...
    onTabChange = (key) => {
        ...
        switch (key) {
            ...
            case "待审核详情":
                this.state.url = "/bzj/auditList";
                this.curCheckState = "bzj-checkPending";
                break;
            case "审核未通过详情":
                this.state.url = "/bzj/rejectList";
                this.curCheckState = "bzj-unapprove";
                break;
            case "审核失败详情":
                this.state.url = "/bzj/failList";
                this.curCheckState = "bzj-checkFail";
                break;
            case "审核成功详情":
                this.state.url = "/bzj/sucList";
                this.curCheckState = "bzj-checkSuccess";
                break;
        }
        this.setState({
            url: this.state.url,
    ...
    linkDetails = (record) => {
        ...
        this.props.history.push("/main/cashDepositDetails")
    }
